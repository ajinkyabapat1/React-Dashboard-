...
import MainChartExample from '../Component/charts/MainChartExample'
import logo from '../assets/logo.png'
//const WidgetsDropdown = lazy(() => import('../Component/widgets/WidgetsDropdown'))
    ...
    <>
      ...
      <CCard>
        <CCardBody>
          <CRow>
            <CCol sm="5">
              <h4 id="traffic" className="card-title mb-0">Health Condition</h4>
              <div className="small text-muted">Mar-2021</div>
            </CCol>
                ...
                <CCol xs="12" md="6" xl="6">
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      ...
                      <span className="title">Cancer</span>
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      ...
                      <span className="title">Blood Prssure</span>
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      ...
                      <span className="title">Heart Attack</span>
                  ...
                  <div className="progress-group">
                    <div className="progress-group-header">
                      <CIcon name="cib-linkedin" className="progress-group-icon" />
                      <span className="title">Diabetic</span>
                      <span className="ml-auto font-weight-bold">27,319 <span className="text-muted small">(8%)</span></span>
                    </div>
                    <div className="progress-group-bars">
                      <CProgress className="progress-xs" color="success" value="5" />
                    </div>
                  </div>
              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={logo} style={{height:20,width:20}} className="c-avatar-img" alt="admin@tempmail.com" />
                  ...
                  <tr>
                    ...
                    <td className="text-center"><strong>IND</strong>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
